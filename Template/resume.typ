...
#let section_headlines = (
  resume: (pt: "Resumo profissional", en: "Professional summary"),
  experience: (pt: "Experiência profissional", en: "Professional experience"),
  education: (pt: "Formação acadêmica e complementar", en: "Education and certifications"),
)
...
#import "../Bullets/summary.typ": summary

#v(12pt)
#align(center)[
  #text(size: 12pt, weight: "bold")[#t(summary.headline_title)]
  
  #v(2pt)
  #text(size: 11pt, style: "italic", fill: rgb("#333333"))[
    #t(summary.headline_subtitle)
  ]
]

// --- Resumo Profissional ---

#import "../Bullets/summary_items.typ": summary_items

#section_title[#t(section_headlines.resume)]

#let summary_items_local = t(summary_items)
#for item in summary_items_local {
  summary_item[#item]
}
...
#section_title[#t(section_headlines.experience)]
...
// PETROBRAS
#let company3 = t(companies.petrobras)
#company_header(company3.name, company3.period)


#import "../Bullets/petrobras.typ" as exp4
#let experiences4 = (
  bigtech: exp4.bigtech,
  scaleup: exp4.scaleup,
  startup: exp4.startup,
  other: exp4.other,
)

#job_position(t(exp4.position))
#let experience = t(experiences4.at(profile.experience_type))
#for bullet in experience {
  bullet_item[#bullet]
}
